...
class PathOptimizer:
    ...
    def optimize_spiral(self, xf, yf, tf):
        ...
        p0 = [0.0, 0.0, sf_0]  # THIS IS THE INITIAL GUESS FOR OPTIMIZER
    ...
    def objective_grad(self, p):
        ...
        return np.add(
            np.add(
                np.add(self.fbe_grad(p), np.multiply(25, self.fxf_grad(p))),
                np.multiply(25, self.fyf_grad(p)),
            ),
            np.multiply(30, self.ftf_grad(p)),
        )
    ...
    def fxf(self, p):
        ...
        t14 = p[3] - t2 + t3 - t4
        t15 = self._xf - p[4] * (
            cos(p[0] * p[4] - p[4] * t9 * (1.0 / 4.0) - p[4] * t13 * (1.0 / 3.0) + p[4] * t14 * (1.0 / 2.0))
            + cos(
                p[0] * p[4] * (1.0 / 2.0)
                - p[4] * t9 * (1.0 / 6.4e1)
                - p[4] * t13 * (1.0 / 2.4e1)
    ...
    def fxf_grad(self, p):
        ...
        t0 = (
            ...
            * (
                ...
                - p[4]
                * (
                    cos(t15 - p[4] * t9 * (1.0 / 4.0) - p[4] * t13 * (1.0 / 3.0) + p[4] * t14 * (1.0 / 2.0))
                    + cos(t16 - p[4] * t9 * (1.0 / 6.4e1) - p[4] * t13 * (1.0 / 2.4e1) + p[4] * t14 * (1.0 / 8.0)) * 2.0
                    + cos(t17 - p[4] * t9 * 7.91015625e-2 - p[4] * t13 * (9.0 / 6.4e1) + p[4] * t14 * (9.0 / 3.2e1))
                    * 2.0
                    + cos(t18 - p[4] * t9 * 9.765625e-4 - p[4] * t13 * (1.0 / 1.92e2) + p[4] * t14 * (1.0 / 3.2e1))
                    * 2.0
                    + cos(
                        t19 - p[4] * t9 * 4.94384765625e-3 - p[4] * t13 * (9.0 / 5.12e2) + p[4] * t14 * (9.0 / 1.28e2)
                    )
                    * 4.0
                    + cos(
                        t20
        ...
        t0 = (
            ...
            * (
                ...
                * (
                    cos(t15 - p[4] * t9 * (1.0 / 4.0) - p[4] * t13 * (1.0 / 3.0) + p[4] * t14 * (1.0 / 2.0))
                    + cos(t19 - p[4] * t9 * 7.91015625e-2 - p[4] * t13 * (9.0 / 6.4e1) + p[4] * t14 * (9.0 / 3.2e1))
                    * 2.0
                    + cos(
                        t29
                        - p[4] * t9 * 3.814697265625e-2
            ...
            * (
                ...
                * 1.2740478515625
                - p[4] * sin(t18) * (3.0 / 6.4e1)
                - p[4] * sin(t22) * 1.201171875e-1
        ...
        t0 = (
            (
                ...
                * (
                    ...
                    + cos(t22 - t53 - t54 + p[4] * t14 * (4.9e1 / 1.28e2)) * 4.0
                    + 1.0
                )
                * (1.0 / 2.4e1)
            )
            * (
                ...
                - p[4]
                * (
                    sin(t24) * (p[0] * (1.0 / 8.0) + p[1] * (3.0 / 8.0) + p[2] * (3.0 / 8.0) + p[3] * (1.0 / 8.0))
                    + sin(t26)
                    * (
                        p[0] * (1.5e1 / 1.28e2)
                        + p[1] * (5.1e1 / 1.28e2)
                    ...
                    * 2.0
                    + sin(t28)
                    * (p[0] * 1.2060546875e-1 + p[1] * 1.7724609375e-1 - p[2] * 6.005859375e-2 + p[3] * 1.220703125e-2)
                    * 2.0
                    + sin(t30)
                    * (p[0] * 1.1279296875e-1 + p[1] * 4.3505859375e-1 + p[2] * 1.9775390625e-1 + p[3] * 4.39453125e-3)
                    * 2.0
                    + sin(t32)
                    * (
                        p[0] * 8.7615966796875e-2
                        + p[1] * 5.6488037109375e-2
                        - p[2] * 2.4261474609375e-2
                        + p[3] * 5.157470703125e-3
                    )
                    * 4.0
                    + sin(t34)
                    * (
                        p[0] * 1.24237060546875e-1
                        + p[1] * 3.04046630859375e-1
                        - p[2] * 6.6741943359375e-2
                        + p[3] * 1.3458251953125e-2
                    )
                    * 4.0
                    + sin(t36)
                    * (
                        p[0] * 1.11541748046875e-1
                        + p[1] * 4.41741943359375e-1
                        + p[2] * 7.0953369140625e-2
                        + p[3] * 7.62939453125e-4
                    )
                    * 4.0
                    + sin(t38)
                    * (
                        p[0] * 1.19842529296875e-1
                        + p[1] * 3.99261474609375e-1
                        + p[2] * 3.18511962890625e-1
                        + p[3] * 3.7384033203125e-2
                    )
                    * 4.0
                )
                * (1.0 / 2.4e1)
    ...
    def fyf(self, p):
        ...
        t14 = p[3] - t2 + t3 - t4
        t15 = self._yf - p[4] * (
            sin(p[0] * p[4] - p[4] * t9 * (1.0 / 4.0) - p[4] * t13 * (1.0 / 3.0) + p[4] * t14 * (1.0 / 2.0))
            + sin(
                p[0] * p[4] * (1.0 / 2.0)
                - p[4] * t9 * (1.0 / 6.4e1)
                - p[4] * t13 * (1.0 / 2.4e1)
    ...
    def fyf_grad(self, p):
        ...
        t0 = (
            ...
            * (
                p[4] * cos(t24) * (3.0 / 8.0)
                + p[4] * cos(t26) * (5.1e1 / 6.4e1)
                + p[4] * cos(t28) * 8.701171875e-1
                + p[4] * cos(t30) * 3.544921875e-1
                + p[4] * cos(t32) * 1.2161865234375
                + p[4] * cos(t34) * 2.259521484375e-1
                + p[4] * cos(t36) * 1.7669677734375
        ...
        t0 = (
            ...
            * (
                p[4] * cos(t18) * (3.0 / 6.4e1)
                + p[4] * cos(t22) * 1.201171875e-1
                + p[4] * cos(t25) * 2.669677734375e-1
                + p[4] * cos(t28) * 9.70458984375e-2
                - p[4] * cos(t32) * (3.0 / 8.0)
                - p[4] * cos(t34) * 3.955078125e-1
                - p[4] * cos(t36) * 2.838134765625e-1
        ...
        t0 = (
            ...
            * (
                ...
                + p[4]
                * (
                    cos(t24) * (p[0] * (1.0 / 8.0) + p[1] * (3.0 / 8.0) + p[2] * (3.0 / 8.0) + p[3] * (1.0 / 8.0))
                    + cos(t26)
                    * (
                        p[0] * (1.5e1 / 1.28e2)
                        + p[1] * (5.1e1 / 1.28e2)
    ...
    def ftf(self, p):
        t2 = (
            self._tf
            - p[0] * p[4]
            + p[4] * (p[0] * (1.1e1 / 2.0) - p[1] * 9.0 + p[2] * (9.0 / 2.0) - p[3]) * (1.0 / 2.0)
            + p[4]
            * (p[0] * (9.0 / 2.0) - p[1] * (2.7e1 / 2.0) + p[2] * (2.7e1 / 2.0) - p[3] * (9.0 / 2.0))
            * (1.0 / 4.0)
            - p[4] * (p[0] * 9.0 - p[1] * (4.5e1 / 2.0) + p[2] * 1.8e1 - p[3] * (9.0 / 2.0)) * (1.0 / 3.0)
        )
        t0 = t2 * t2
        return t0
    ...
    def ftf_grad(self, p):
        ...
        t0 = (
            (p[0] * (1.0 / 8.0) + p[1] * (3.0 / 8.0) + p[2] * (3.0 / 8.0) + p[3] * (1.0 / 8.0))
            * (
                self._tf
                - p[0] * p[4]
                + p[4] * (p[0] * (1.1e1 / 2.0) - p[1] * 9.0 + p[2] * (9.0 / 2.0) - p[3]) * (1.0 / 2.0)
